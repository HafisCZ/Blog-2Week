<?php
// source: C:\blog\app\presenters/templates/Sign/in.latte

class Template3e8ad938bb7165491671d01e28483e37 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('be317dbd96', 'html')
;
